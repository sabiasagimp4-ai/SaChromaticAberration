...
既定値 (収差 40px / 減衰 2.0 / ラジアル 8°) は、参考にしたレンズ収差の見た目に寄せてあります。
そのぶん 1 画素あたり数百回サンプリングするので、再生が重い場合は収差かラジアルを下げてください。
減衰を 4 より大きくすると、必要サンプル数が上限 512 を超えて縞が出たり、
参照範囲の拡張上限 4096px に当たって画面端で収差が切れたりします。
