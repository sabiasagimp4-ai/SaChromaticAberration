...
既定値は収差 40px / 減衰 2.0 / ラジアル 8° / ステップ数 32 です。
...
`python tests/radial_regression.py INPUT.jpg OUTPUT.png` で修正前後の CPU 参照画像を作れます。
NumPy / Pillow が必要です。比較は収差 40px、減衰 2、スケール 0、128 サンプル、Radial 30/90/180°。
